...
export const FLOCK_RELAY_SNAPSHOT: FlockRelaySnapshot = Object.freeze({
  ...
  sourceSha: "91d9cfbe5b3b9a6ba390382d51183277bf5b5ce9",
  observedAt: "2026-07-18T00:45:00.000Z",
  branch: "codex/harvey-mobile-vpg-20260717",
  executionOwner: "CODEX_ROOT",
  workMode: "CLOUD_ONLY",
  packets: Object.freeze([
    Object.freeze({
      packetId: "F_DINK_HARVEY_MOBILE_RELAY_SURFACE_20260717_C3",
      address: "DINK@MEDULLINA",
      state: "READY_FOR_PULL",
      internalRoleAgent: true,
    }),
    Object.freeze({
      packetId: "F_CURSOR_ENDER_HARVEY_MOBILE_RELAY_UX_20260717_C3",
      address: "CURSOR_ENDER_DOOZER@MEDULLINA",
      state: "READY_FOR_PULL_INTERNAL_ROLE_AGENT",
      internalRoleAgent: true,
    }),
    Object.freeze({
      packetId: "F_BEAN_THUFIR_HARVEY_MOBILE_RELAY_AUDIT_20260717_C3",
  ...
  proofBoundary:
    "Committed packet state is a snapshot, not a live relay. Green builds prove neither delivery, canon, merge, hosting, nor deployment.",
  externalEnderState: "BLOCKED_UNBOUND",
});
